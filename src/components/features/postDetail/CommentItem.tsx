...
export default function CommentItem({
	...
	return (
		<li className="flex items-center gap-[10px] py-6 border-b border-[#d9d9d9] dark:border-[#616161]">
			...
			<div className="flex flex-col">
				<div className="flex items-center gap-1">
					...
					{comment.author._id === authorId && (
						<span className="text-[9px] bg-[#06b796] rounded-[10px] py-[1px] px-1">
							작성자
						</span>
					)}
				</div>
				<span className="text-sm mb-[2px]">{value}</span>
				<div className="text-[#616161] dark:text-[#dadada]">
