...
export default function ProfileHeader({
	...
	return (
		<div className="border-b border-[#F3F3F3] sm:border-0 px-[16px] sm:p-0 fixed top-0 left-0 w-full z-50 bg-white h-[70px] flex items-center justify-between mb-[36px] sm:static">
			<div className="flex">
				<button
