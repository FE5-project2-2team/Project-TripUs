		...
		<div className="flex flex-col md:flex-row min-h-screen">
			...
			<div className="w-full md:w-1/2 flex flex-col items-center justify-center px-6 md:px-[80px] lg:pl-[300px] py-16 text-center">
				...
				<img 
					...
					className="mx-auto"
				/>
				<div className="mt-12 flex flex-col gap-y-7 text-[17px] sm:text-[18px] md:text-[20px] font-medium text-[#333333]">
				...
				<div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
					...
					className="select-none w-full sm:w-[197px] h-[52px] md:h-[56px] flex items-center justify-center px-6 md:px-[45px] py-3 md:py-[16px] rounded-[10px] shadow-sm text-[17px] md:text-[18px] font-bold text-[#06B796] bg-[#DFF7E5] hover:bg-[#E9FFEE]"
					>
					이전 페이지
					</button>
				</div>
