...
## 기능 소개
### 홈
<img width="800" src="https://github.com/user-attachments/assets/cd2467d0-e648-4158-a8a3-af8b37d895f0">
<hr>

- 홈화면에는 전체, 항해보기, 항해일지(후기), 크루모집(동행원모집), 지금 탑승 가능!(긴급모집) 채널이 있습니다.
- 긴급모집 채널에서는 여행시작일로부터 3일이내인 크루모집 게시글들이 보여집니다.
- 필터를 통해 동행 조건(성별,나이)과 모집중인 게시글을 필터링할 수 있습니다.
- 인기순, 최신순(작성날짜), 날짜순(여행날짜)으로 게시글들을 정렬할 수 있습니다.
- 작성자의 닉네임, 게시글 제목, 내용, 여행지명 으로 게시글을 검색할 수 있습니다.
...
### 채팅
![메시지 진입부터 대화 gif](https://github.com/user-attachments/assets/6bb36f11-a867-4cf1-a1cb-ec9a4424c194)
![메시지 리스트 검색 gif](https://github.com/user-attachments/assets/2ff2ddb8-1c5b-4b6f-8ad3-d76941a52f4c)
<hr>

- 채팅은 유저프로필을 통해 들어와 대화를 시작하거나 채팅 목록에서 대화할 상대를 검색해 시작할 수 있습니다.
- 채팅에서 좌측은 채팅방 목록, 우측은 채팅창입니다.
- 채팅방 목록에서는 읽지 않은 메시지 유무, 마지막 메시지, 마지막 메시지가 온 시간을 알 수 있으며 대화를 나눈 상대방을 검색해서 찾을 수 있습니다.
- 채팅창에서는 상대방과 대화를 주고 받은 내역을 볼 수 있으며 여기서 상대방의 이름, 프로필 이미지를 확인할 수 있습니다.

### 알림
![Image](https://github.com/user-attachments/assets/6bc86294-86d1-49fe-a5ea-9ff2b1c55333)
<hr>

- 알림에서는 5초 간격으로 알림목록을 받아옵니다.
- 댓글과 좋아요를 포함한 게시글, 동행신청, 채팅을 알림으로 받을 수 있습니다.
- 알림을 개별적으로 누르면 읽음처리가 되고, 해당 게시글이나 채팅 페이지로 이동합니다.
- 모두 읽음을 누르면 모든 알림이 읽음처리가 됩니다.
